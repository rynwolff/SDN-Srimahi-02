    <script src="<?= base_url() ?>assets/templates/frontend/clever/js/jquery/jquery.min.js"></script>
    <!-- ##### Catagory Area Start ##### -->
    <div class="">
    <div class="clever-catagory blog-details bg-img d-flex align-items-center justify-content-center p-3 height-400" style="background-image: url(<?= base_url('assets/img/blog/').$blog_detail['blog_img']; ?>);">
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-12 col-lg-6">
                    <div class="post-a-comments mb-70">
                        ...
                        <form id="formComment" action="<?= base_url('Blog/detail/').$blog_detail['blog_slug'] ?>" method="post">
                            <div class="row">
                                <div class="col-12">
...
<div class="modal fade" id="modal-balas-komentar" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form method="post" action="<?= base_url('Blog/reply_comment') ?>">
